    ...
    <div className="dashboard">
      ...
      <main className="main-content">
        <header className="topbar">
          <div>
            <p className="eyebrow">CYBER THREAT INTELLIGENCE PLATFORM</p>
        ...
        <section className="stats-grid">
          <div className="stat-card">
            ...
            <strong>{loading ? '—' : statistics.total}</strong>
          ...
          <div className="stat-card">
            ...
            <strong>{loading ? '—' : statistics.highRisk}</strong>
            <span className="stat-description">
              High + critical
            </span>
          </div>
          ...
          <div className="stat-card">
            ...
            <strong>{loading ? '—' : statistics.critical}</strong>
            <span className="stat-description">
              Immediate attention
            </span>
          </div>
          ...
          <div className="stat-card">
            ...
            <strong>{loading ? '—' : statistics.sources}</strong>
            <span className="stat-description">
          ...
          <div className="panel">
            <div className="panel-header">
              <div>
                ...
                <p>Current IOC severity profile</p>
              </div>
            </div>
            ...
            <div className="risk-list">
              {['critical', 'high', 'medium', 'low'].map((level) => {
                ...
                const percentage =
                  iocs.length > 0
                    ? Math.round((count / iocs.length) * 100)
                    : 0
        ...
        <section className="panel table-panel">
          <div className="panel-header">
            <div>
              ...
              <p>Latest indicators stored in PostgreSQL</p>
            </div>
